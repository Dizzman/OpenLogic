...
Model.Add_P2IMix_ObjectByMTPRows(ObjName="LinkP2IMix1", FromObjectName="Purchase1",ToObjectName="Inventory1", xlsxfile="Mix (Purch To Inv)1 - MixYieldMTP.xlsx")
Model.Add_I2SMix_ObjectByMTPRows(ObjName="LinkP2IMix1",FromObjectName="Inventory1",ToObjectName="Sales1",xlsxfile="Mix (Inv to Sales)1 - MixDistributionMTP.xlsx")

Model.Build_BackPropogationLP()
#Model.Solve()